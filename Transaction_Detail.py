...
st.markdown(
    ...
    <div style="background:#fff8f8;border:1.5px solid #f5c2c7;border-radius:10px;padding:24px 28px;">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:15px;">
            <tr><td style="color:#888;padding:6px 0;width:140px">🏦 Bank</td>
                <td><b>{bank}</b></td></tr>
            <tr><td style="color:#888;padding:6px 0">📅 Date & Time</td>
                <td><b>{ts}</b></td></tr>
            <tr><td style="color:#888;padding:6px 0">💬 Description</td>
                <td>{message}</td></tr>
            <tr><td style="color:#888;padding:6px 0">🏷️ Subtype</td>
                <td>{subtype}</td></tr>
            <tr><td style="color:#888;padding:6px 0">⚠️ Alert Threshold</td>
                <td>₹{threshold:,.0f}</td></tr>
            <tr><td style="color:#888;padding:6px 0">🕐 Flagged At</td>
                <td>{created}</td></tr>
        </table>
    </div>
    """,
