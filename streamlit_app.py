...
# Ensure notif_df exists (defensive guard)
if 'notif_df' not in locals():
    notif_df = pd.DataFrame()

# ─────────────────────────────────────────────
# ── BELL ICON HEADER & Notifications-only view
# (Moved here so notif_df is defined before it's used)
# ─────────────────────────────────────────────
...
with bell_col:
    ...
    # Render bell as a toggle button. Clicking flips session state.
    if st.button(
        bell_label,
        key="bell_btn",
...
# If notifications panel toggled on, show ONLY notifications and stop the script there.
...
# ─────────────────────────────────────────────
# If we reach here, notifications panel is NOT open — continue rendering the main app.
# ─────────────────────────────────────────────
st.info(
